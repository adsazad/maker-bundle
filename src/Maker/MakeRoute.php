...
/**
 * @author Arashdeep Singh <singh@arashdeep.co.in>
 */
final class MakeController extends AbstractMaker
{
    ...
    {
        return 'Creates a new route inside controller class';
    }
    ...
    public function configureCommand(Command $command, InputConfiguration $inputConfig): void
    {
        $command
            ...
            ->addArgument('route-path', InputArgument::OPTIONAL, 'The path for the route')
            ->addArgument('route-name', InputArgument::OPTIONAL, 'The name for the route')
            ->setHelp(file_get_contents(__DIR__.'/../Resources/help/MakeRoute.txt'))
        ;
    }
